...
pipe = Pipeline("sd", processors="tokenize,pos,lemma,depparse",
                package="default_accurate",
                depparse_model_path="saved_models/depparse/sd_isra_muril-large-cased_parser.pt",
                pos_model_path="saved_models/pos/sd_isra_muril-large-cased_tagger.pt",
