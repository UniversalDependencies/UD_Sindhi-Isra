...
cat not-to-release/xpos_features/adabi_2.conllu >> sd_isra-ud-dev.conllu

cp not-to-release/xpos_features/xpos_tagged_with_features.conllu sd_isra-ud-train.conllu

filenames=`ls not-to-release/xpos_features/* | grep -v sd_780 | grep -v _md_ | grep -v xpos_tagged_with_features | grep -v adabi_0.conllu | grep -v adabi_1.conllu | grep -v adabi_2.conllu`
