...
ALLOWED_UPOS_TO_FEATS = {
    "ADJ":   ['Case=Nom', 'Case=Obl', 'Degree=Cmp', 'Degree=Pos', 'Degree=Sup', 'Gend=Fem', 'Gend=Masc', 'Number=Plur', 'Number=Sing'],
    "ADP":   ['Case=Gen', 'Case=Nom', 'Case=Obl', 'Gend=Fem', 'Gend=Masc', 'Number=Plur', 'Number=Sing', 'Person=3', 'Type=Gen', 'Type=Loc'],
    "ADV":   ['Case=Nom', 'Case=Obl', 'Gend=Fem', 'Gend=Masc', 'Number=Plur', 'Number=Sing', 'Person=3'],
    ...
    "CCONJ": [],
    "DET":   ['Case=Gen', 'Case=Nom', 'Case=Obl', 'Gend=Fem', 'Gend=Masc', 'Number=Plur', 'Number=Sing', 'Person=3'],
    "INTJ":  ['Type=Call'],
    ...
    "VERB":  ['Aspect=Con', 'Aspect=Imp', 'Aspect=Perf',
              ...
              'Mood=Des',
              'Number=Plur', 'Number=Sing', 'Number[Obj]=1', 'Number[Obj]=Pl', 'Number[Obj]=Sg', 'Number[Subj]=Pl', 'Number[Subj]=Sg',
