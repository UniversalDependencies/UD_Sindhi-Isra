...
ALLOWED_UPOS_TO_FEATS = {
    ...
    "AUX":   ['Aspect=Imp', 'AuxType=Be', 'Gender=Fem', 'Gender=Masc', 'Mood=Sub', 'Number=Plur', 'Number=Sing', 'Person=1', 'Person=2', 'Person=3', 'Polarity=Neg', 'Tense=Fut', 'Tense=Past', 'Tense=Pres', 'VerbForm=Inf', 'Voice=Pass'],
    "CCONJ": [],
