...
ALLOWED_UPOS_TO_FEATS = {
    "ADJ":   ['Case=Acc', 'Case=Nom', 'Degree=Cmp', 'Degree=Pos', 'Degree=Sup', 'Gend=Fem', 'Gend=Masc', 'Number=Plur', 'Number=Sing'],
    "ADP":   ['Case=Acc', 'Case=Gen', 'Case=Nom', 'Gend=Fem', 'Gend=Masc', 'Number=Plur', 'Number=Sing', 'Person=3', 'Type=Gen', 'Type=Loc'],
    "ADV":   ['Case=Acc', 'Case=Nom', 'Gend=Fem', 'Gend=Masc', 'Number=Plur', 'Number=Sing', 'Person=3'],
    ...
    "PROPN": ['Case=Abl', 'Case=Acc', 'Case=Nom', 'Gend=Fem', 'Gend=Masc', 'Number=Sing'],
    "PUNCT": [],
    "SCONJ": [],
    "SYM":   [],
