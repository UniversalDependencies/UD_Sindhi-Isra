...
# demonstratives
demonstratives =      ['اِهو', 'انهي', 'انهي', 'انهيءِ', 'اِهو', 'اِهي', 'اها', 'اهڙو', 'اهي', 'ڪوبه', 'هرڪوئي', 'هِن', 'هُوءَ', 'هن', 'اُهو', 'اهي', 'اهو', 'اِها']
# orthographic variants - replace ه with ھ
demonstratives.extend(['اِھو', 'انھي', 'انھي', 'انھيءِ', 'اِھو', 'اِھي', 'اھا', 'اھڙو', 'اھي', 'ڪوبھ', 'ھرڪوئي', 'ھِن', 'ھُوءَ', 'ھن', 'اُھو', 'اھي', 'اھو', 'اِھا'])
# more demonstratives
