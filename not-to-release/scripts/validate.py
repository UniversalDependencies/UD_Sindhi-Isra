...
# demonstratives
demonstratives = ['ان', 'اِهو', 'انهي', 'انھي', 'انهيءِ', 'اِهو', 'اِهي', 'اھا', 'اھڙو', 'اھي', 'ڪوبه', 'هرڪوئي', 'هِن', 'هُوءَ', 'ھن', 'اُهو', 'اُھو', 'اهي', 'اهو', 'اِها']
demonstratives.extend(['اُها', 'اها', 'انهيءَ'])
demonstratives.extend(['ڪهڙيءَ', 'ڪهڙين', 'ڪهڙي', 'ڪهڙيون', 'جيڪي', 'جيڪا', 'اسان'])
