...
# can/could AUX words
for word in ('سگهي', 'سگهنديس', 'سگهندس', 'سگهندا', 'سگهنداسون', 'سگهنداسين', 'سگهنديون', 'سگهيس', 'سگهبو', 'سگهنديس'):
    ENFORCED_POS[word] = ['AUX']

# variant spellings of the above
for word in ('سگھي', 'سگھنديس', 'سگھندس', 'سگھندا', 'سگھنداسون', 'سگھنداسين', 'سگھنديون', 'سگھيس', 'سگھبو', 'سگھنديس'):
    ENFORCED_POS[word] = ['AUX']
